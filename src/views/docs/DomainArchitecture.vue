<template>
  <div class="relative min-h-screen bg-space-darker bg-opacity-90 p-8">
    ...
    <div class="fixed inset-0 bg-gradient-to-br from-cyan-900/10 to-purple-900/10 pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-4xl mx-auto">
      ...
      <div class="mb-12">
        <div class="flex items-center gap-4 mb-6">
          ...
          <h1 class="text-3xl font-bold text-interface-text-primary">Domain Architecture</h1>
        </div>
        <p class="text-xl text-interface-text-muted">Understanding the core architecture of the Space Explorer platform</p>
      </div>
...
onMounted(async () => {
  try {
    const response = await fetch('/docs/architecture/DOMAIN_ARCHITECTURE.md')
