<template>
  <div class="relative min-h-screen bg-space-darker bg-opacity-90 p-8">
    ...
    <div class="fixed inset-0 bg-gradient-to-br from-green-900/10 to-teal-900/10 pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-4xl mx-auto">
      ...
      <div class="mb-12">
        <div class="flex items-center gap-4 mb-6">
          ...
          <h1 class="text-3xl font-bold text-interface-text-primary">Deployment Flow</h1>
        </div>
        <p class="text-xl text-interface-text-muted">Understanding the deployment process and procedures</p>
      </div>
...
onMounted(async () => {
  try {
    const response = await fetch('/docs/deployment/DEPLOYMENT_FLOW.md')
